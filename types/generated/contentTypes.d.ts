...
export interface ApiPropertyProperty extends Schema.CollectionType {
  ...
  attributes: {
    ...
    P_Level__c: Attribute.String;
    P_Num__c: Attribute.String;
    Promotion_Price_Discount_Perc_20_80__c: Attribute.String;
    Property_Num__c: Attribute.String;
    Property_Size_Sqm_Formula__c: Attribute.String;
    SAP_Building_ID__c: Attribute.String;
    SAP_Property_ID__c: Attribute.String;
    SAP_Property_Number__c: Attribute.String;
    SOURCEID__c: Attribute.String;
    warehouse_numbers__c: Attribute.String;
    Discount_Percent_price_2_20_80__c: Attribute.String;
    Base_Price_Discount_Percentage__c: Attribute.String;
    Base_Price_Discount_Percentage2__c: Attribute.String;
    Promotion_Price_Discount_Percentage__c: Attribute.String;
    Proprety_Bmby_Name__c: Attribute.String;
    Building__c: Attribute.String;
    Building_Number_for_report__c: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
